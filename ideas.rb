DateIdeas.plan do
  ...
  date "make crepes" do
    kind :adventure => 2, :romantic => 4, :intellectual => 2, :athletic => 2
    requires :weather => 0, :hours => 1
  end

  date "durham farmer's market" do
    kind :adventure => 4, :romantic => 2, :intellectual => 2, :athletic => 4
    requires :weather => 6, :hours => 2
  end

  date "sunrise over somewhere other than lsrc" do
    kind :adventure => 8, :romantic => 7, :intellectual => 4, :athletic => 7
    requires :weather => 7, :hours => 4
  end
  ...
  date "swimming in the quarry" do
    kind :adventure => 7, :romantic => 4, :intellectual => 2, :athletic => 7
    requires :weather => 7, :hours => 2
  end
